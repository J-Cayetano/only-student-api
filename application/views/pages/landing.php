            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url('<?php echo base_url('assets') ?>/media/svg/illustrations/landing.svg')">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="http://localhost/only-student#home">
                                    <img alt="Logo" src="<?php echo base_url('assets') ?>/media/logos/os-logo.png" class="logo-default h-35px h-lg-45px" />
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        <!--begin::Title-->
                        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">#1 Online Learning Solution
                            <br />with
                            <span style="background: linear-gradient(to right, #9055FF 0%, #13E2DA 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    ...
                    <div class="fs-5 text-muted fw-bold">Your education is important to us
                        <br />for we provide an effective platform for tutorial
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Heading-->
                ...
                <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
                    ...
                    <div class="my-2 me-5">
                        <!--begin::Title-->
                        <span class="fs-1 fs-lg-2qx fw-bolder text-white mb-2">Join <?php echo SYSTEM_NAME ?> Today, <br>
                            <span class="fw-normal">want to be a Tutor?</span></span>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <!--end::Content-->
                    <!--begin::Link-->
                    <a href="#" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Click here to Apply now!</a>
                    <!--end::Link-->
                </div>
                <!--end::Highlight-->
            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="d-flex fw-bold flex-column ms-lg-20">
                                    ...
                                    <a href="https://www.facebook.com/keenthemes" class="mb-6">
                                        <img src="<?php echo base_url('assets') ?>/media/svg/brand-logos/facebook-4.svg" class="h-20px me-2" alt="" />
                                        <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Facebook</span>
                                    </a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                    <a href="https://github.com/KeenthemesHub" class="mb-6">
                                        <img src="<?php echo base_url('assets') ?>/media/svg/brand-logos/github.svg" class="h-20px me-2" alt="" />
                                        <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Github</span>
                                    </a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                    <a href="https://twitter.com/keenthemes" class="mb-6">
                                        <img src="<?php echo base_url('assets') ?>/media/svg/brand-logos/twitter.svg" class="h-20px me-2" alt="" />
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            <!--begin::Logo-->
                            <a href="http://localhost:3600/only-student#home">
                                <img alt="Logo" src="<?php echo base_url('assets') ?>/media/logos/os-logo.png" class="h-25px h-md-35px" />
                            </a>
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
