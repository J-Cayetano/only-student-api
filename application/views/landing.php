                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="http://localhost:3600/only-student#home">
                                    <img alt="Logo" src="/media/logos/os-logo.png" class="logo-default h-35px h-lg-45px" />
                                </a>
                                <!--end::Logo image-->
                            </div>
                            <!--end::Logo-->
                            ...
                            <div class="flex-equal text-end ms-1">
                                <a href="http://localhost:3600/only-student/login" class="btn btn-success">Sign In</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">#1 Online Learning Solution
                            ...
                            <span style="background: linear-gradient(to right, #9055FF 0%, #13E2DA 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">;
                                <span id="kt_landing_hero_text">The Only Student</span>
                            </span>
                        </h1>
                        <!--end::Title-->
                        <!--begin::Action-->
                        <a href="#" class="btn btn-primary">Be a Student</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                </div>
        ...
        <div class="mt-20 mb-n20 position-relative z-index-2">
            ...
            <div class="container">
                ...
                <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
                    ...
                    <div class="my-2 me-5">
                        <!--begin::Title-->
                        <span class="fs-1 fs-lg-2qx fw-bolder text-white mb-2">Join {{title}} Today, <br>
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            <!--begin::Logo-->
                            <a href="http://localhost:3600/only-student#home">
                                <img alt="Logo" src="/media/logos/os-logo.png" class="h-25px h-md-35px" />
                            </a>
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
